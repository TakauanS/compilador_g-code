...
class ViewCyDesbasteP(ctk.CTkFrame):
    ...
    cor1 = '#F2F1F0' # Cor branca para FG-COLOR
    ...
    def __init__(self, master, toplevel):
        try:
            ...
            # SEÇÃO DE FRAMEs
            self.__master.fra_code = ctk.CTkFrame(self.__master.fra_main, width=880, height=330, corner_radius=8, border_width=1, fg_color=ViewCyDesbasteP.cor1)
            ...
            self.__master.label_title = self.__assents.criar_label('Ciclo de Desbaste | Parametrizado', 10, 5, 
                                                                   text_color=ViewCyDesbasteP.cor2, font=('Corbel', 22, 'bold'), 
                                                                   frame=self.__master.fra_main)
            
            self.__master.label_sub = self.__assents.criar_label(ViewCyDesbasteP.sub, 10, 35, 
                                                                 text_color=ViewCyDesbasteP.cor3, font=('Corbel', 18, 'normal'), 
                                                                 frame=self.__master.fra_main)
            ...
            self.__master.label_prp = self.__assents.criar_label('PREVIEW - CODE', 10, 110, 
                                                                 text_color=ViewCyDesbasteP.cor2, 
                                                                 font=('Corbel', 23, 'bold'), 
                                                                 frame=self.__master.fra_code)
            
            self.__master.label_prt = self.__assents.criar_label(ViewCyDesbasteP.pre, 10, 140, 
                                                                 text_color=ViewCyDesbasteP.cor3, 
            ...
            self.__master.label_man = ctk.CTkLabel(self.__master.fra_main,
                                                    font=('Corbel', 18, 'normal'),
                                                    text_color=ViewCyDesbasteP.cor2,  
                                                    text=f'CMP_MAIN{self.__json.get_data(self.__json.data_file, 'extensão')}')
            self.__master.label_man.place(x=15, y=240)

            self.__master.label_con = ctk.CTkLabel(self.__master.fra_main,
                                                    font=('Corbel', 18, 'normal'),
                                                    text_color=ViewCyDesbasteP.cor2, 
                                                    text=f'CMP_CONTROLS{self.__json.get_data(self.__json.data_file, 'extensão')}')
            ...
            # SEÇÃO DE BUTTONs
            self.__master.but_par = ctk.CTkButton(self.__master.fra_menu, width=15, height=15, text='', corner_radius=0, image=ViewCyDesbasteP.img_par, fg_color=ViewCyDesbasteP.cor1, hover_color=ViewCyDesbasteP.cor1)
            ...
            self.__master.preview_code1 = ctk.CTkTextbox(self.__master.fra_main, width=430, height=100, corner_radius=8, border_width=1).place(x=15, y=270)
            self.__master.preview_code2 = ctk.CTkTextbox(self.__master.fra_main, width=420, height=100, corner_radius=8, border_width=1).place(x=455, y=270)
