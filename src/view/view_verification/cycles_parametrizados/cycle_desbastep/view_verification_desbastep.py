...
class ViewVerificationDesbasteP(ctk.CTkToplevel):
    ...
    def __init__(self):
        try:
            ...
            # SEÇÃO DE MENU BAR
            #self.menu = Menu(self)
            #self.menu_arquivo = Menu(self.menu, tearoff=0) # Menu para o arquivo
            #self.menu_configs = Menu(self.menu, tearoff=0) # Menu para as configurações
            #self.menu_avancad = Menu(self.menu_configs, tearoff=0) # Menu para as configurações avançadas
            #self.menu_paramet = Menu(self.menu_avancad, tearoff=0) # Menu para os parâmetros de corte
