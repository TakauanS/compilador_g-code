from src.controller.gcode_generator.cycles_funcionais.gcode_furacaof import Gcode_FuracaoF
from src.model.assents import Assents
from src.controller.menu import Menu
from tkinter import messagebox

class FuracaoF_Manager:
        ...
        if self.entry_posicaox.get() == '' or self.entry_posicaoz.get() == '':
            ...
            if validacao_posicao == 'yes':
                ...
                try:
                    ...
                    ciclo_furacao = Gcode_FuracaoF(posicao_x, posicao_z, espessura, rotacao, avanco, passe_c, referencia, ferramenta, posx, posz)
