from src.controller.gcode_generator.cycles_funcionais.gcode_faceamentof import Gcode_FaceamentoF
from src.model.assents import Assents
from src.controller.menu import Menu
from tkinter import messagebox

class FaceamentoF_Manager:
        ...
        if self.entry_diametroi.get() == '' or self.entry_diametrof.get() == '':
            ...
            if validacao_diametro == 'yes':
                ...
                try:
                    ...
                    ciclo_faceamento = Gcode_FaceamentoF(diametro_inicial, diametro_final, espessura, rotacao, avanco, passe, referencia, ferramenta, posx, posz)
