...
class BackDesbasteF:
    ...
    def __init__(self, master):
        ...
        label_linha = ctk.CTkLabel(master=self.master, text='ㅤ', image=BackDesbasteF.img_linha)
        ...
        self.button_code = self.__assents.criar_button(text='G-CODE', command=self.gcode_desbastef, image=BackDesbasteF.img_code, x=705, y=355)
        
    def gcode_desbastef(self):
        ...
        if self.entry_diametroi.get() == '' or self.entry_diametrof.get() == '':
            ...
            if validacao_diametro == 'yes':
                ...
                try:
                    ...
                    ciclo_desbaste = Desbaste_Funcional(diametro_inicial=diametro_inicial, diametro_final=diametro_final, espessura=espessura)
                    ...
                    ciclo_desbaste.pos_segurancaX(posx=self.menu.get_posx)
                    ciclo_desbaste.pos_segurancaZ(posz=self.menu.get_posz)
